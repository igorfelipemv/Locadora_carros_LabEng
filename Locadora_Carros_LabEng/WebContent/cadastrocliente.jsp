...
<body>
	...
	<div align="right">
			<label>Usuário: ${loginRetorno}</label><br/>
			<label>Perfil: ${perfil}</label>
		</div>
		 ...
		 <tbody>
			<c:forEach items="${listacliente}" var="cliente">
				<tr>
					...
					<td><a href="/Locadora_Carros_LabEng/mostracliente?id=${cliente.id}">Alterar</a></td>
					<td><a href="/Locadora_Carros_LabEng/excluircliente?id=${cliente.id}">Excluir</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
